...
# メニュー項目描画
def draw_menumanual(self,context):
...
class MYADDON_OT_export_scene(bpy.types.Operator,bpy_extras.io_utils.ExportHelper):
    ...
    def export(self):
        ...
        with open(self.filepath,"wt") as file:
            ...
            for object in bpy.context.scene.objects:
                ...
                self.parse_scene_resursive(file,object,0)
    ...
    def parse_scene_resursive(self,file,object,level):
        """シーン解析用再起関数"""
        ...
        #子ノードへ進む(深さが1上がる)
        for child in object.children:
            self.parse_scene_resursive(file,child,level + 1)
...
class OBJECT_PT_file_name(bpy.types.Panel):
    ...
    def draw(self,context):
        ...
        if"file_name" in context.object:
            ...
            self.layout.operator(MUADDON_OT_add_filename.bl_idname)
...
class MUADDON_OT_add_filename(bpy.types.Operator):
